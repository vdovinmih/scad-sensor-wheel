...
controller_dim    = [15, 12, 2.25 ];
//power_dim        = [10, 4, 1.5 ];
antenna_dim      = [7.5, 16, 0.05 ];
antenna_led_dim = [1, 1.5, 0.2 ];
...
module wemos_esp8266_plate_2d(cut=false) {
    if (cut) {
        difference() {
            plate_2d(board_dim[0], board_dim[1], corner_radius=0);
...
comp_info = [
    ...
    [cpu_info(),            controller_dim,  [ 1,-1,-1], [0,0,2], [-1, 1, -1], [1.3, -2, -controller_dim[2]]],
    [antenna_info(),        antenna_dim,     [ 1,-1,-1], [0,0,2], [1, 1, -1],  [-antenna_dim[0], 0, -antenna_dim[2]]],
    [led_info(),            antenna_led_dim, [ 1,-1,-1], [0,2,0], [1, 1, -1],  [-antenna_dim[0], -3.5, -antenna_dim[2]]],
];
